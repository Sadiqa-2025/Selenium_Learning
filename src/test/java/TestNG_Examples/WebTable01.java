...
for the country 'canada' get the company name
 */
public class WebTable01 {
    ...
    public void getCompanyName(){
        ...
        //for the country 'canada' get the company name
        WebElement canada = driver.findElement(By.xpath("//table[@id='customers']//td[text() ='Canada']/preceding-sibling::td"));
        System.out.println("the company name for Canada is "+ canada.getText());
        driver.quit();
    }
}
